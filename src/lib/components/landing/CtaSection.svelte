			...
			<div class="relative flex w-full flex-col items-center justify-center overflow-hidden">
				...
				<div class="absolute z-10">
					...
					<div class="z-10 mt-4 flex flex-col items-center text-center text-primary">
						<h1 class="text-3xl font-bold lg:text-4xl">Stop wasting time on finding your answers.</h1>
						<p class="mt-2">Try Now</p>
				<Button size="lg" variant="outline" href="https://ai-pdf-assist.streamlit.app/" class="group mt-4 rounded-[2rem] px-6">
    Get Started
    <ChevronRight
