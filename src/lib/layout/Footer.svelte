	...
	<div class="mx-auto w-full max-w-screen-xl xl:pb-2">
		<div class="gap-4 p-4 px-8 py-16 sm:pb-16 md:flex md:justify-between">
			<div class="mb-12 flex flex-col gap-4">
				<a href="https://ai-pdf-assist.streamlit.app/" class="flex items-center gap-2">
					<svg
			...
			<p class="max-w-xs">PDF Assistant: Scrape, Merge, and Query PDFs with Ai</p>
		...
		>
			...
			<span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">
				...
				{' '}
				<a href="/" class="cursor-pointer">Ai PDF assist</a>
				. All Rights Reserved.
			</span>
		</div>
	</div>
